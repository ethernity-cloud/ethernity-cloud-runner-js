...
// JSON.stringify chokes on here: bigints (ethers v6 returns them) and circular
// refs (ethers tx/receipt objects). Mirrors `util.inspect(x, {depth: null})`
// closely enough for a debug log line.
const inspect = (value) => {
